<template>
  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      ...
      <side-menu isTag="router-link" title="Dashboard" icon="view-grid" :route="{ to: 'books.dashboard' }"></side-menu>
      <side-menu isTag="router-link" title="Assuntos" icon="file" :route="{ to: 'books.assuntos' }"></side-menu>
      <side-menu isTag="router-link" title="Autores" icon="user-group" :route="{ to: 'books.autores' }"></side-menu>
      <side-menu isTag="router-link" title="Livros" icon="bookmark" :route="{ to: 'books.index' }"></side-menu>
<!--      <side-menu isTag="router-link" title="Relatorio" icon="document" :route="{ to: 'books.index' }"></side-menu>-->
<!--      <side-menu isTag="router-link" title="Livros" icon="view-grid" :route="{ to: 'books.index' }"></side-menu>-->
