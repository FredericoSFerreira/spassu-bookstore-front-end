          ...
          <li class="nav-item dropdown">
            <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button"
              ...
              <div class="caption ms-3 d-none d-md-block">
                <h6 class="mb-0 caption-title">{{ usuario.nome }}</h6>
                <p class="mb-0 caption-sub-title">{{ usuario.email }}</p>
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              ...
              <li>
                <router-link class="dropdown-item" :to="{ name: 'auth.login' }" @click="logout()">Sair</router-link>
              </li>
            </ul>
          </li>
        </ul>
